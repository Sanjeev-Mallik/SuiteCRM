...
export declare class DynamicFieldComponent implements OnInit {
    ...
    constructor(navigation: ModuleNavigation, moduleNameMapper: ModuleNameMapper, router: Router, dynamicLabelService: DynamicLabelService, linkRouteAsyncActionService: LinkRouteAsyncActionService);
