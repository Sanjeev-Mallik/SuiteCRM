...
export declare class FieldLogicManager extends BaseActionManager<FieldLogicActionData> {
     ...
     */
    runLogic(field: Field, mode: ViewMode, record: Record, triggeringStatus?: string, dependentField?: Field): void;
    /**
     ...
     * @param triggeringStatus
     */
    protected parseModeActions(declaredActions: Action[], mode: ViewMode, triggeringStatus: string, fieldDependent: Field): any[];
