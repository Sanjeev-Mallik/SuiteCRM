 ...
 */
import { AfterViewInit, ElementRef, WritableSignal } from '@angular/core';
...
export declare class GroupFieldComponent extends BaseFieldComponent implements AfterViewInit {
    ...
    wrapper: ElementRef;
    direction: WritableSignal<string>;
    hasValidConfig: boolean;
    protected recalculateDirectionBuffer: Subject<boolean>;
    protected recalculateDirectionBuffer$: Observable<any>;
    onResize(): void;
    constructor(typeFormatter: DataTypeFormatter, registry: StandardFieldRegistry, logic: FieldLogicManager, logicDisplay: FieldLogicDisplayManager, config: SystemConfigStore);
    ngOnInit(): void;
