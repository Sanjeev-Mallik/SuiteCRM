...
export declare class RecordActionManager extends BaseActionManager<RecordActionData> {
    ...
    constructor(edit: RecordEditAction, create: RecordCreateAction, toggleWidgets: RecordToggleWidgetsAction, cancel: RecordCancelAction, cancelCreate: CancelCreateAction, save: RecordSaveAction, saveNew: RecordSaveNewAction, saveContinue: RecordSaveContinueAction, async: AsyncProcessRecordAction);
