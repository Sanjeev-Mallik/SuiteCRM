...
export declare class CreateViewStore extends RecordViewStore {
    ...
    constructor(recordFetchGQL: RecordFetchGQL, recordSaveGQL: RecordSaveGQL, appStateStore: AppStateStore, languageStore: LanguageStore, navigationStore: NavigationStore, moduleNavigation: ModuleNavigation, metadataStore: MetadataStore, localStorage: LocalStorageService, message: MessageService, subpanelFactory: SubpanelStoreFactory, recordManager: RecordManager, statisticsBatch: StatisticsBatch, auth: AuthService, recordStoreFactory: RecordStoreFactory, preferences: UserPreferenceStore, panelLogicManager: PanelLogicManager, recordConvertService: RecordConvertService);
    /**
    ...
    duplicateOnModule(): Observable<Record>;
    /**
