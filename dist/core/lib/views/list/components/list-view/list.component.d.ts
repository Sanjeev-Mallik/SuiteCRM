...
export declare class ListComponent implements OnInit, OnDestroy {
    ...
    constructor(appState: AppStateStore, listStore: ListViewStore, quickFilters: QuickFiltersService, sidebarWidgetHandler: ListViewSidebarWidgetService, recordPaginationService: RecordPaginationService);
    ngOnInit(): void;
    ngOnDestroy(): void;
    updateListLocalStorage(): void;
