...
export declare abstract class BaseTypeRegistry<T> implements RegistryInterface<T> {
    protected map: OverridableMap<Type<T>>;
    protected constructor();
    getKey(module: string, type: string): string;
    register(module: string, type: string, objectType: Type<T>): void;
