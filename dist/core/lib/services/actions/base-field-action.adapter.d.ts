...
export declare abstract class BaseFieldActionsAdapter<D> extends BaseActionsAdapter<D> {
    ...
    static ɵfac: i0.ɵɵFactoryDeclaration<BaseFieldActionsAdapter<any>, never>;
    static ɵprov: i0.ɵɵInjectableDeclaration<BaseFieldActionsAdapter<any>>;
}
