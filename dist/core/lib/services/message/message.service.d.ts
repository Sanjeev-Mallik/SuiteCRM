...
export declare class MessageService {
    ...
    addSuccessMessageByKey(labelKey: string, defaultText?: string): number;
    addDangerMessage(text: string): number;
    addDangerMessageByKey(labelKey: string, defaultText?: string): number;
    addWarningMessage(text: string): number;
    addWarningMessageByKey(labelKey: string, defaultText?: string): number;
