...
export declare class ImageComponent implements OnInit, OnDestroy {
    ...
    imageName: import("@angular/core").WritableSignal<string>;
    imageMap: {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ImageComponent, "scrm-image", never, { "klass": { "alias": "klass"; "required": false; }; "title": { "alias": "title"; "required": false; }; "wrapperClass": { "alias": "wrapperClass"; "required": false; }; "image": { "alias": "image"; "required": false; }; }, {}, never, never, false, never>;
}
