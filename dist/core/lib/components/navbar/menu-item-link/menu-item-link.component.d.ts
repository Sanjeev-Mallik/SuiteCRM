...
export declare class MenuItemLinkComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<MenuItemLinkComponent, "scrm-menu-item-link", never, { "link": { "alias": "link"; "required": false; }; "icon": { "alias": "icon"; "required": false; }; "class": { "alias": "class"; "required": false; }; "config": { "alias": "config"; "required": false; }; }, {}, never, never, false, never>;
}
