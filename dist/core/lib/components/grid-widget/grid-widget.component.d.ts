...
import { ContentAlign, ContentJustify, StatisticWidgetLayoutCol, StatisticWidgetLayoutRow, StatisticWidgetOptions, TextColor, TextSizes, WidgetMetadata } from '../../common/metadata/widget.metadata';
import { FieldMap } from '../../common/record/field.model';
import { SingleValueStatisticsState } from '../../common/statistics/statistics-store.model';
import { StatisticMetadata } from '../../common/statistics/statistics.model';
...
export declare class GridWidgetComponent implements OnInit, OnDestroy {
    ...
    initializing: WritableSignal<boolean>;
    private subs;
    private statistics;
    private loading$;
