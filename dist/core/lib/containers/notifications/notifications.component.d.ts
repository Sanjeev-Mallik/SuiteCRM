...
export declare class NotificationsComponent implements OnInit {
    ...
    options: any;
    constructor(language: LanguageStore, systemConfig: SystemConfigStore, message: MessageService, notificationService: NotificationsService, notificationStore: NotificationStore);
    ngOnInit(): void;
