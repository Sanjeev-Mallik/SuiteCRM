...
export declare class SubpanelComponent implements OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<SubpanelComponent, "scrm-subpanel", never, { "store": { "alias": "store"; "required": false; }; "maxColumns$": { "alias": "maxColumns$"; "required": false; }; "onClose": { "alias": "onClose"; "required": false; }; "filterConfig": { "alias": "filterConfig"; "required": false; }; "panelHeaderButtonClass": { "alias": "panelHeaderButtonClass"; "required": false; }; }, {}, never, never, false, never>;
}
