...
function TableComponent_scrm_table_footer_3_Template(rf, ctx) { if (rf & 1) {
    ...
    const ctx_r0 = i0.ɵɵnextContext();
    i0.ɵɵproperty("bulkActions", ctx_r0.config.bulkActions)("paginationType", ctx_r0.getPaginationType())("pagination", ctx_r0.config.pagination)("selection", ctx_r0.config.selection)("tableActions", ctx_r0.config == null ? null : ctx_r0.config.tableActions)("config", ctx_r0.config);
} }
