...
export class FileDetailFieldComponent extends BaseFieldComponent {
    ...
    static { this.ɵfac = function FileDetailFieldComponent_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || FileDetailFieldComponent)(i0.ɵɵdirectiveInject(i1.DataTypeFormatter), i0.ɵɵdirectiveInject(i2.FieldLogicManager), i0.ɵɵdirectiveInject(i3.FieldLogicDisplayManager), i0.ɵɵdirectiveInject(i4.LegacyEntrypointLinkBuilder)); }; }
